...
/**
 * SuhApiLogger 설정 프로퍼티
 * application.yml에서 suh-api-logger 관련 설정을 관리
 */
@ConfigurationProperties(prefix = "suh-api-logger")
public class SuhApiLoggerProperties {
