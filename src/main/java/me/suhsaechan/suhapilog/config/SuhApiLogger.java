...
import me.suhsaechan.suhapilog.util.CommonUtil;
import me.suhsaechan.suhapilog.util.SuhTimeUtil;

/**
 * SuhApiLogger 유틸리티 클래스
...
public class SuhApiLogger {
	...
	// 로거 인스턴스
	private static final Logger logger = SuhApiLoggerConfig.getLogger();
	
	private static final ObjectMapper objectMapper = createObjectMapper();
	
	// 설정 프로퍼티 (Spring Context에서 주입받을 수 있도록)
	private static SuhApiLoggerProperties properties;
	 ...
	 */
	public static void setProperties(SuhApiLoggerProperties properties) {
		SuhApiLogger.properties = properties;
	}
	...
	public static void setLogLevel(LogLevel level) {
		switch (level) {
			case DEBUG:
				SuhApiLoggerConfig.setLogLevel(Level.FINE);
				break;
			case INFO:
				SuhApiLoggerConfig.setLogLevel(Level.INFO);
				break;
			case WARN:
				SuhApiLoggerConfig.setLogLevel(Level.WARNING);
				break;
			case ERROR:
				SuhApiLoggerConfig.setLogLevel(Level.SEVERE);
				break;
		}
	}
	...
	public static void setLogLevel(Level level) {
		SuhApiLoggerConfig.setLogLevel(level);
	}
	...
	public static void addFileLogger(String logFilePath) {
		SuhApiLoggerConfig.addFileHandler(logFilePath);
	}
	...
	public static SuhApiLogger getLogger(Class<?> clazz) {
		return new SuhApiLogger();
	}
	
	// 인스턴스 메서드들 (기존 코드 호환성)
	public void debug(String message, Object... args) {
		debug(formatMessage(message, args));
	}

	public void info(String message, Object... args) {
		info(formatMessage(message, args));
	}

	public void warn(String message, Object... args) {
		warn(formatMessage(message, args));
	}

	public void error(String message, Object... args) {
		error(formatMessage(message, args));
	}


	private String formatMessage(String message, Object... args) {
		if (args.length == 0) {
			return "[SUH-API-LOG] : " + message;
		}
		return "[SUH-API-LOG] : " + String.format(message.replace("{}", "%s"), args);
	}
}