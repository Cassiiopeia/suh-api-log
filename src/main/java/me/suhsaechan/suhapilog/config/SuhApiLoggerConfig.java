...
/**
 * SuhApiLogger의 설정을 담당하는 클래스
 * 로거 인스턴스 생성 및 포맷터 설정 담당
 */
public class SuhApiLoggerConfig {

  private static final String LOGGER_NAME = "me.suhsaechan.suhapilog";
  ...
  private static Logger createLogger() {
    // me.suhsaechan.suhapilog 네임스페이스의 독립 로거 생성
    // 전역 로거 설정 변경 안함
  ...
  public static class SuhLogFormatter extends Formatter {
    ...
    private String getAbbreviatedClassName(LogRecord record) {
      ...
      for (StackTraceElement element : stackTrace) {
        ...
        if (!className.startsWith("me.suhsaechan.suhapilog") && 
